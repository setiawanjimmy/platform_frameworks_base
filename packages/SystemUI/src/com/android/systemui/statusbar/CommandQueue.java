...
public class CommandQueue extends IStatusBar.Stub {
    ...
    public interface Callbacks {
        ...
        default void handleShowShutdownUi(boolean isReboot, boolean isRebootRecovery, String reason) { }
    }
    ...
    @Override
    public void showShutdownUi(boolean isReboot, boolean isRebootRecovery, String reason) {
        synchronized (mLock) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_SHOW_SHUTDOWN_UI:
                    for (int i = 0; i < mCallbacks.size(); i++) {
                        mCallbacks.get(i).handleShowShutdownUi(msg.arg1 != 0, msg.arg2 != 0,
                                (String) msg.obj);
                    }
                    break;
